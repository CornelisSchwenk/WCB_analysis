...
global TRAJ_PATH        = "/lustre/project/nhr-tpchange/gziyan/online_trajs/case01_20150825/"
global NWP_PATH         = "/lustre/project/nhr-tpchange/amiltenb/wcb_case_20150825/"
...
global START_OF_SIM     = DateTime(2015,8,25,0,0,0) #year, month, day, hour, minute, second
global END_OF_SIM       = DateTime(2015,8,29,12,0,0)
...
global NUMBER_RTIME_STEPS::Int  = 209
...
global TIME_CHECK_1 = DateTime(2015,8,26,0,0) #enter first check time here
global LON_CHECK_1 = (-40,0) #in degrees, enter values here
global LAT_CHECK_1 = (37,60) #in degrees, enter values here

global TIME_CHECK_2 = DateTime(2015,8,28,0,0) #enter second check time here
global LON_CHECK_2 = (-10,30) #in degrees, enter values here
global LAT_CHECK_2 = (42,66) #in degrees, enter values here
